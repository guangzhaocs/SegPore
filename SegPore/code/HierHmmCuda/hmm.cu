...
int *b_st_sig_ind_arr_h;
int *b_en_sig_ind_arr_h;

float *B_mu_mat_h;
float *B_sigma_mat_h;
float *B_prev_mu_mat_h;
float *B_prev_sigma_mat_h;
float *B_next_mu_mat_h;
float *B_next_sigma_mat_h;

float *B_hmm_loglik_arr_h;

//// for debug
//float *emis_h;     //  BATCH, LEN
//float *alpha_h;    //  BATCH, STATE*LEN
//float *beta_h;     //  BATCH, STATE*LEN
//float *gamma_h;    //  BATCH, STATE*LEN
//float *c_h;        //  BATCH, LEN
int *state_h;      //  BATCH, LEN
...
int *b_st_sig_ind_arr_d;
int *b_en_sig_ind_arr_d;

float *B_mu_mat_d;
float *B_sigma_mat_d;
float *B_prev_mu_mat_d;
float *B_prev_sigma_mat_d;
float *B_next_mu_mat_d;
float *B_next_sigma_mat_d;

float *B_hmm_loglik_arr_d;


float *emis_d;    //  BATCH, LEN
float *alpha_d;   //  BATCH, STATE*LEN
float *beta_d;    //  BATCH, STATE*LEN
float *gamma_d;   //  BATCH, STATE*LEN
float *c_d;       //  BATCH, LEN
int *state_d;     //  BATCH, LEN
...
void HMM_Param(int M, int win_num, int LEN){
